        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-3">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => clearAllWallets("SOLANA")}
                ...
                >
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={() => deleteWallet("SOLANA", wallet.public_key)}
                  ...
                  <div>
                    ...
                    <p className="font-mono text-sm xs:text-xs break-all truncate max-w-full bg-gray-50 p-3 rounded-lg border border-gray-100">
                      {showPrivateKeys[wallet.public_key]
                        ? wallet.private_key
                        : "•".repeat(64)}
                    </p>
